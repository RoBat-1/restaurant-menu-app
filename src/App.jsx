...
function App() {
  ...
  const [milkshakeItems, setMilkshakeItems] = useState([]);
  ...
  useEffect(() => {
    const loadMenuData = async () => {
      setLoading(true);
      try {
        const [kaak, waffles, specialWaffles, crepes, specialCrepes, newItemsCrepes, milkshakes, juice, birthdays] = await Promise.all([
  ...
  return (
    <div className="app">
      <header className="app-header">
        <h1 className="restaurant-name">🍽️ Creppino de Tawso</h1>
      ...
      <footer className="app-footer">
        <p>© 2025 Creppino de Tawso | All prices in USD</p>
        <div className="social-links">
          <a 
            href="https://wa.me/96170991598" 
            target="_blank" 
          ...
          <a 
            href="https://www.instagram.com/crepinodetawso/?hl=en" 
            target="_blank" 
            rel="noopener noreferrer"
          ...
          <a 
            href="https://www.facebook.com/p/Cr%C3%AAppino-De-tawso-100054209424259/" 
            target="_blank" 
            rel="noopener noreferrer"
