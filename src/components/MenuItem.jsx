...
const MenuItem = ({ item, photosOnly = false, orderText }) => {
  const handleWhatsAppOrder = () => {
    const message = `Hello! I would like to order: ${item.name}${item.price ? ' - ' + item.price : ''}`;
      ...
      {!photosOnly && (
        <div className="menu-item-content">
          ...
          >
            ...
            {orderText ? orderText : 'Order via WhatsApp'}
          </button>
        </div>
      )}
    </div>
